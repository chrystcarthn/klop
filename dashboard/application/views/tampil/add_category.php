    ...
    <div class="col-xs-12">
        ...
        <div class="box box-success" style="width: 550px;">
            ...
            <!-- form start -->
             ...
             <form method="post" role="form" action="<?php echo base_url('index.php/Main/add_category') ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <!--</div>-->
                  <input type="text" required class="form-control" id="namecategory" name="namecategory" placeholder="Ketik nama kategori...">
                </div>
               <div class="form-group">
