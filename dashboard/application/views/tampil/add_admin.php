    ...
    <div class="col-xs-12">
        ...
        <div class="box box-success" style="width: 550px;">
            ...
            <!-- form start -->
             ...
             <form method="post" role="form" action="<?php echo base_url('index.php/Main/add_admin') ?>">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <!--</div>-->
                  <input type="text" required class="form-control" id="nameadmin" name="nameadmin" placeholder="Ketik nama admin...">
                </div>
				<div class="form-group">
              ...
              <div class="box-footer">
                <a href="#" class="btn btn-default btn-m" onclick="viewadmin()">Batal</a>
        ...
        <script type="text/javascript">
            ...
            function viewadmin(){
                document.location='<?php echo base_url(); ?>index.php/Main/admin/';
            }
        </script>
