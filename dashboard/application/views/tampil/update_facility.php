    ...
    <div class="col-xs-12">
        ...
        <div class="box box-success" style="width: 550px;">
            <div class="box-header with-border">
              <h3 class="box-title">Ubah Fasilitas</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
             <form method="post" role="form" action="<?php echo base_url('index.php/Main/update_facility') ?>">
              <div class="box-body">
                <div class="form-group">
                <?php foreach ($dataupdate->result() as $key) { ?>
                  <label for="text">Nama Fasilitas</label>
                     <input type="hidden" class="form-control" id="id" name="id" placeholder="Id" value="<?php echo $key->ID_FACILITY_DB; ?>">
                    <input type="text" required class="form-control" id="namefacility" name="namefacility" placeholder="Ketik nama fasilitas..." value="<?php echo $key->NAME_FACILITY; ?>">
