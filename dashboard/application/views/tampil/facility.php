    ...
    <div class="col-xs-12">
      ...
      <div class="box box-primary">
        <div class="box-header">
          ...
          <a href="#" class="btn btn-success btn-m" onclick="addfacility()">+ Tambah fasilitas baru</a>
        ...
        <div class="box-body">
          ...
          <script type="text/javascript">
            ...
            function updatefacility(param){
                document.location='<?php echo base_url(); ?>index.php/Main/update_fac/'+param;
            }
            function addfacility(){
                document.location='<?php echo base_url(); ?>index.php/Main/add_new_fac/';
            }
            </script>
