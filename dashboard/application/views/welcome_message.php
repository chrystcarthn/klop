...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Masuk ke sesi Admin</p>
    ...
    <form method="post" action="">
      ...
      <div class="form-group has-feedback">
        <input type="password" required name="password" class="form-control" placeholder="Kata Sandi">
...
<script type="text/javascript">
    ...
    function registerpage(){
        document.location='<?php echo base_url(); ?>index.php/Welcome/gotoregister/';
    }
</script>
</body>
</html>
