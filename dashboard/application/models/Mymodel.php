...
class Mymodel extends CI_Model {
	...
	{
	    $this->db->select('category.ID_CATEGORY_DB, category.NAME_CATEGORY, category.PUBLISHED, category.CREATED, (select FULL_NAME from users where ID_USER = category.CREATED_BY) "NamaAC" , category.UPDATED, (select FULL_NAME from users where ID_USER = category.UPDATED_BY) "NamaAU"');
